...
public class NetworkThreadToMainThreadDispatcher : MonoBehaviour
{
    ...
    private static NetworkThreadToMainThreadDispatcher _instance = null;
    ...
    public static NetworkThreadToMainThreadDispatcher Instance()
    {
        if (!Exists())
        {
