...
namespace UdpToolkit.Framework.Events
{
    ...
    {
        protected static IEnumerable<EventDescriptor> FindEventsWithAttribute<TAttribute>() where TAttribute : Attribute, IEventAttribute
        {
        ...
        private static IEnumerable<Type> FindTypesWithAttribute<TAttribute>() where TAttribute : Attribute, IEventAttribute
        {
            return AppDomain
                .CurrentDomain
                .GetAssemblies()
