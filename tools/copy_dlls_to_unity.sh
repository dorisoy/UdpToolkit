...
cp ./server_build/UdpToolkit.Annotations.dll                         ./src/unity/UdpToolkit.Unity/Assets/Plugins/UdpToolkit/
cp ./server_build/UdpToolkit.Framework.dll                           ./src/unity/UdpToolkit.Unity/Assets/Plugins/UdpToolkit/
cp ./server_build/UdpToolkit.Framework.CodeGenerator.Contracts.dll   ./src/unity/UdpToolkit.Unity/Assets/Plugins/UdpToolkit/
