...
dotnet pack ./src/shared/UdpToolkit.Annotations/UdpToolkit.Annotations.csproj                                               -p:PackageVersion=$PACKAGE_VERSION --configuration Release
...
dotnet pack ./src/shared/UdpToolkit.Framework.CodeGenerator.Contracts/UdpToolkit.Framework.CodeGenerator.Contracts.csproj   -p:PackageVersion=$PACKAGE_VERSION --configuration Release
...
dotnet pack ./src/generators/UdpToolkit.CodeGenerator/UdpToolkit.CodeGenerator.csproj         -p:PackageVersion=$PACKAGE_VERSION --configuration Release
dotnet pack ./src/generators/UdpToolkit.CodeGeneratorCli/UdpToolkit.CodeGeneratorCli.csproj   -p:PackageVersion=$PACKAGE_VERSION --configuration Release