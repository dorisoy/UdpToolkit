...
dotnet nuget push ./src/shared/UdpToolkit.Annotations/bin/Release/UdpToolkit.Annotations.$PACKAGE_VERSION.nupkg                                                 --api-key $NUGET_KEY --source https://api.nuget.org/v3/index.json
...
dotnet nuget push ./src/shared/UdpToolkit.Framework.CodeGenerator.Contracts/bin/Release/UdpToolkit.Framework.CodeGenerator.Contracts.$PACKAGE_VERSION.nupkg     --api-key $NUGET_KEY --source https://api.nuget.org/v3/index.json
...
dotnet nuget push ./src/generators/UdpToolkit.CodeGenerator/bin/Release/UdpToolkit.CodeGenerator.$PACKAGE_VERSION.nupkg         --api-key $NUGET_KEY --source https://api.nuget.org/v3/index.json
dotnet nuget push ./src/generators/UdpToolkit.CodeGeneratorCli/bin/Release/UdpToolkit.CodeGeneratorCli.$PACKAGE_VERSION.nupkg   --api-key $NUGET_KEY --source https://api.nuget.org/v3/index.json